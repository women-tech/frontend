...
function C(a,b,c){Function.prototype.bind&&-1!=Function.prototype.bind.toString().indexOf("native code")?C=Qa:C=Sa;return C.apply(null,arguments)}
...
function b(p){for(var u=g,q=0;64>q;q+=4)u[q/4]=p[q]<<24|p[q+1]<<16|p[q+2]<<8|p[q+3];for(q=16;80>q;q++)p=u[q-3]^u[q-8]^u[q-14]^u[q-16],u[q]=(p<<1|p>>>31)&4294967295;p=e[0];var B=e[1],E=e[2],V=e[3],fd=e[4];for(q=0;80>q;q++){if(40>q)if(20>q){var Ra=V^B&(E^V);var Tb=1518500249}else Ra=B^E^V,Tb=1859775393;else 60>q?(Ra=B&E|V&(B|E),Tb=2400959708):(Ra=B^E^V,Tb=3395469782);Ra=((p<<5|p>>>27)&4294967295)+Ra+fd+Tb+u[q]&4294967295;fd=V;V=E;E=(B<<30|B>>>2)&4294967295;B=p;p=Ra}e[0]=e[0]+p&4294967295;e[1]=e[1]+
B&4294967295;e[2]=e[2]+E&4294967295;e[3]=e[3]+V&4294967295;e[4]=e[4]+fd&4294967295}
...
var fe=gd;function Xd(a){G.call(this,a)}
...
;function U(a,b){"function"===typeof a&&(a=Ge(a));return window.setTimeout(a,b)}
...
b.va&&0<b.timeout&&(f=U(function(){e||(e=!0,Ve(f),b.va.call(b.context||y))},b.timeout))}else df(a,b)}
...
b.withCredentials);
if(b.R&&0<b.timeout){var g=b.R;var h=U(function(){e||(e=!0,f.abort(),Ve(h),g.call(b.context||y,f))},b.timeout)}return f}
...
try{Df[a]?f():U(f,0)}catch(g){S(g)}},void 0);
...
function Nf(a,b,c){c=void 0===c?null:c;var d=Of(a),e=document.getElementById(d),f=e&&yf(e,"loaded"),g=e&&!f;f?b&&b():(b&&(f=Ef(d,b),b=""+Na(b),Pf[b]=f),g||(e=Qf(a,d,function(){yf(e,"loaded")||(wf(e),Hf(d),U(Ta(If,d),0))},c)))}
...
;function Xf(){}
v(Xf,Tf);function Vf(a,b,c){isNaN(c)&&(c=void 0);var d=A("yt.scheduler.instance.addJob");return d?d(a,b,c):void 0===c?(a(),NaN):U(a,c||0)}
...
function Hg(){T("web_gel_timeout_cap")&&!zg&&(zg=U(Fg,6E4));Ve(yg);var a=R("LOGGING_BATCH_TIMEOUT",Re("web_gel_debounce_ms",1E4));T("shorten_initial_gel_batch_timeout")&&Bg&&(a=tg);yg=U(Fg,a)}
...
function eh(a,b,c){a=a.f.transaction(b,c);return new hh(a)}
function gh(a){this.f=a}
n=gh.prototype;n.add=function(a,b){return X(this.f.add(a,b))};
...
ih.prototype.count=function(a){return X(this.f.count(a))};
ih.prototype.get=function(a){return X(this.f.get(a))};
function jh(a,b){this.request=a;this.f=b}
function kh(a){return X(a).then(function(b){return null===b?null:new jh(a,b)})}
jh.prototype["delete"]=function(){return X(this.f["delete"]()).then(function(){})};
jh.prototype.getValue=function(){return this.f.value};
jh.prototype.update=function(a){return X(this.f.update(a))};function lh(a,b,c){function d(){m||(m=new ch(f.result));return m}
var e=hh;var f=void 0!==b?self.indexedDB.open(a,b):self.indexedDB.open(a);var g=c.f,h=c.blocking,k=c.g,l=c.upgrade,m;l&&f.addEventListener("upgradeneeded",function(p){if(null===p.newVersion)throw Error("Invariant: newVersion on IDbVersionChangeEvent is null");if(null===f.transaction)throw Error("Invariant: transaction on IDbOpenDbRequest is null");var u=d(),q=new e(f.transaction);l(u,p.oldVersion,p.newVersion,q)});
g&&f.addEventListener("blocked",function(){g()});
return X(f).then(function(p){h&&p.addEventListener("versionchange",function(){h(d())});
k&&p.addEventListener("close",function(){k()});
return d()})}
function mh(a,b,c){c=void 0===c?{}:c;return lh(a,b,c)}
;var nh,oh,ph=["getAll","getAllKeys","getKey","openKeyCursor"],qh=["getAll","getAllKeys","getKey","openKeyCursor"];function rh(){return N(this,function b(){var c,d,e;return x(b,function(f){switch(f.f){case 1:if(kf&&lf()&&!mf()&&!T("ytidb_allow_on_ios_safari_v8_and_v9")||!self.indexedDB)return f["return"](!1);ra(f);e=!1;return w(f,mh("yt-idb-test-do-not-use",void 0,{blocking:function(){e=!0;c&&(c.close(),c=void 0)}}),5);
case 5:return c=f.g,w(f,mh("yt-idb-test-do-not-use",c.f.version+1),6);case 6:return d=f.g,d.close(),d=void 0,f["return"](e);case 3:ta(f);if(c)try{c.close()}catch(g){}if(d)try{d.close()}catch(g){}ua(f);break;case 2:return sa(f),f["return"](!1)}})})}
function sh(){return void 0!==nh?Td(nh):new O(function(a){rh().then(function(b){nh=b;a(b)})})}
function th(){return void 0!==oh?Td(oh):sh().then(function(a){if(!a)return!1;var b=t(ph);for(a=b.next();!a.done;a=b.next())if(!IDBObjectStore.prototype[a.value])return!1;b=t(qh);for(a=b.next();!a.done;a=b.next())if(!IDBIndex.prototype[a.value])return!1;return IDBObjectStore.prototype.getKey?!0:!1}).then(function(a){return oh=a})}
;var uh;function vh(){function a(b){b.close();uh=void 0}
uh||(uh=Wd(mh("YtIdbMeta",1,{blocking:a,upgrade:function(b,c){1>c&&fh(b,"databases",{keyPath:"actualName"})}}),function(b){return bh(b)?mh("YtIdbMeta",void 0,{blocking:a}):Ud(b)}));
return uh}
function wh(a){return vh().then(function(b){return b.get("databases",a.actualName).then(function(c){if(c?a.actualName!==c.actualName||a.publicName!==c.publicName||a.userIdentifier!==c.userIdentifier||a.signedIn!==c.signedIn:1)return c=dh(eh(b,["databases"],"readwrite"),"databases"),X(c.f.put(a,void 0))})})}
function xh(a){return vh().then(function(b){return b["delete"]("databases",a)})}
;function yh(a){try{var b={actualName:"LogsDataBase",publicName:"LogsDataBase",userIdentifier:void 0,signedIn:!1}}catch(c){return Ud(c)}return Wd(wh(b).then(function(){return a(b)}),function(c){return Wd(xh(b.actualName),function(){}).then(function(){return Ud(c)})})}
function zh(a,b){b=void 0===b?{}:b;return yh(function(c){return mh(c.actualName,a,b)})}
;var Ah;function Bh(){return N(this,function b(){return x(b,function(c){if(!Ah)try{Ah=zh(1,{upgrade:function(d,e){1>e&&(fh(d,"LogsRequestsStore",{keyPath:"id",autoIncrement:!0}).f.createIndex("newRequest",["status","authHash","timestamp"],{unique:!1}),fh(d,"sapisid"))}})}catch(d){if(!bh(d))return S(d),c["return"](Promise.reject(d));
Ah=zh()}return c["return"](Ah)})})}
function Ch(a){return N(this,function c(){var d,e,f,g,h;return x(c,function(k){switch(k.f){case 1:return w(k,Bh(),2);case 2:return d=k.g,e=dh(eh(d,["LogsRequestsStore"],"readwrite"),"LogsRequestsStore"),w(k,Dh(),3);case 3:return f=k.g,g=Object.assign(Object.assign({},a),{options:JSON.parse(JSON.stringify(a.options)),authHash:f}),w(k,e.add(g),4);case 4:return h=k.g,k["return"](h)}})})}
function Eh(){return N(this,function b(){var c,d,e,f,g,h,k,l;return x(b,function(m){switch(m.f){case 1:return w(m,Dh(),2);case 2:return c=m.g,d=["NEW",c,0],e=["NEW",c,W()],f=IDBKeyRange.bound(d,e),w(m,Bh(),3);case 3:g=m.g;h=eh(g,["LogsRequestsStore"],"readwrite");var p=dh(h,"LogsRequestsStore").index("newRequest").f.openCursor(f,"prev");p=kh(p);return w(m,p,4);case 4:k=m.g;l=void 0;if(null===k||void 0===k||!k.getValue()){m.F(5);break}l=k.getValue();l.status="QUEUED";return w(m,k.update(l),5);case 5:return m["return"](l)}})})}
function Fh(a){return N(this,function c(){var d,e,f;return x(c,function(g){switch(g.f){case 1:return w(g,Bh(),2);case 2:return d=g.g,e=dh(eh(d,["LogsRequestsStore"],"readwrite"),"LogsRequestsStore"),w(g,e.get(a),3);case 3:return f=g.g,f.status="QUEUED",w(g,X(e.f.put(f,void 0)),4);case 4:return g["return"](f)}})})}
function Gh(a){return N(this,function c(){var d,e,f;return x(c,function(g){switch(g.f){case 1:return w(g,Bh(),2);case 2:return d=g.g,e=dh(eh(d,["LogsRequestsStore"],"readwrite"),"LogsRequestsStore"),w(g,e.get(a),3);case 3:return f=g.g,f.status="NEW",f.sendCount+=1,w(g,X(e.f.put(f,void 0)),4);case 4:return g["return"](f)}})})}
function Hh(){return N(this,function b(){var c,d;return x(b,function(e){if(1==e.f)return w(e,Bh(),2);if(3!=e.f)return c=e.g,w(e,c.count("LogsRequestsStore"),3);d=e.g;return e["return"](!d)})})}
function Ih(a){return N(this,function c(){var d;return x(c,function(e){if(1==e.f)return w(e,Bh(),2);d=e.g;return e["return"](d["delete"]("LogsRequestsStore",a))})})}
function Dh(){return N(this,function b(){var c;return x(b,function(d){if(1==d.f){$g.f||($g.f=new $g);var e={};var f=ad([]);f&&(e.Authorization=f,e["X-Goog-AuthUser"]=R("SESSION_INDEX",0),"INNERTUBE_HOST_OVERRIDE"in ye||(e["X-Origin"]=window.location.origin),T("pageid_as_header_web")&&"DELEGATED_SESSION_ID"in ye&&(e["X-Goog-PageId"]=R("DELEGATED_SESSION_ID")));e=Td(e);return w(d,e,2)}c=d.g;return d["return"](Tg(c))})})}
;var Jh=Re("network_polling_interval",3E4);function Kh(){this.i=0;this.f=window.navigator.onLine;Lh(this);Mh(this)}
function Nh(){Kh.f||(Kh.f=new Kh);return Kh.f}
function Oh(a){var b=Ph,c=Qh;Rh(a);(new O(function(d){a.g=d})).then(function(){b();
c&&(a.h=c)})}
...
function Sh(a){a.i=Uf(function(){window.navigator.onLine?(!1===a.f&&S(Error("NetworkStatusManager missed online event.")),a.f=!0,a.g&&a.g()):(!0===a.f&&S(Error("NetworkStatusManager missed offline event.")),a.f=!1,a.h&&a.h());Sh(a)},Jh)}
;var Th=Re("networkless_throttle_timeout")||100,Uh=Re("networkless_retry_attempts")||1,Vh=0;function Wh(a,b){b=void 0===b?{}:b;Xh().then(function(c){if(c&&!T("networkless_bypass_write")){var d={url:a,options:b,timestamp:W(),status:"NEW",sendCount:0};Ch(d).then(function(e){d.id=e;e=Nh();e.f?Yh(d):Oh(e)})["catch"](function(){Yh(d);
S(Error("Networkless Logging: Log request setting to indexedDB failed."))})}else df(a,b)})}
function Ph(){Vh||(Vh=Wf(function(){Yh();Vh=0;Ph()},Th))}
function Qh(){Yf(Vh);Vh=0}
function Yh(a){N(this,function c(){var d=this,e,f,g,h;return x(c,function(k){switch(k.f){case 1:e=d;if(!a)return w(k,Eh(),6);if(!a.id){k.F(3);break}return w(k,Fh(a.id),5);case 5:a=k.g;k.F(3);break;case 6:if(a=k.g){k.F(3);break}return w(k,Hh(),8);case 8:return(f=k.g)&&Qh(),k["return"]();case 3:if(Zh(a))g=a.options.onError?a.options.onError:function(){},h=a.options.onSuccess?a.options.onSuccess:function(){},a.options.onError=function(l,m){return N(e,function u(){return x(u,function(q){if(1==q.f)return a&&
a.id?a.sendCount<Uh?w(q,Gh(a.id),6):w(q,Ih(a.id),2):q.F(2);
2!=q.f&&(Vh||Oh(Nh()),g(l,m));g(l,m);q.f=0})})},a.options.onSuccess=function(l,m){return N(e,function u(){return x(u,function(q){if(1==q.f)return a&&a.id?w(q,Ih(a.id),2):q.F(2);
h(l,m);q.f=0})})},df(a.url,a.options);
else if(He(Error("Networkless Logging: Stored logs request expired age limit")),a.id)return w(k,Ih(a.id),0);k.F(0)}})})}
function Zh(a){a=a.timestamp;return 2592E6<=W()-a?!1:!0}
function Xh(){return T("networkless_logging")?2===Re("networkless_ytidb_version")?th():sh():Td(!1)}
;function $h(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];d=Error.call(this,a);this.message=d.message;"stack"in d&&(this.stack=d.stack);this.args=[].concat(c instanceof Array?c:fa(t(c)))}
v($h,Error);function ai(a){var b=this;this.f=null;a?this.f=a:Qg()&&(this.f=Jg());Uf(function(){Zg(b)},5E3)}
ai.prototype.isReady=function(){!this.f&&Qg()&&(this.f=Jg());return!!this.f};
function Mg(a,b,c,d){!R("VISITOR_DATA")&&"visitor_id"!==b&&.01>Math.random()&&He(new $h("Missing VISITOR_DATA when sending innertube request.",b,c,d));if(!a.isReady()){var e=new $h("innertube xhrclient not ready",b,c,d);S(e);e.f=0;throw e;}var f={headers:{"Content-Type":"application/json"},method:"POST",D:c,wa:"JSON",R:function(){d.R()},
...
timeout:d.timeout,withCredentials:!0},g="";(e=a.f.Na)&&(g=e);var h=a.f.Pa||!1,k=Rg(h,g,d);Object.assign(f.headers,k);f.headers.Authorization&&!g&&(f.headers["x-origin"]=window.location.origin);e="/youtubei/"+a.f.innertubeApiVersion+"/"+b;var l={alt:"json"};a.f.Oa&&f.headers.Authorization||(l.key=a.f.innertubeApiKey);var m=Le(""+g+e,l||{},!0);Xh().then(function(p){if(d.retry&&T("retry_web_logging_batches")&&"www.youtube-nocookie.com"!=g){if(T("networkless_gel")&&!p||!T("networkless_gel"))var u=Xg(b,
c,k,h);if(u){var q=f.onSuccess,B=f.ua;f.onSuccess=function(E,V){Yg(u);q(E,V)};
c.ua=function(E,V){Yg(u);B(E,V)}}}try{T("use_fetch_for_op_xhr")?af(m,f):T("networkless_gel")&&d.retry?(f.method="POST",Wh(m,f)):(f.method="POST",f.D||(f.D={}),df(m,f))}catch(E){if("InvalidAccessError"==E.name)u&&(Yg(u),u=0),He(Error("An extension is blocking network request."));
else throw E;}u&&Uf(function(){Zg(a)},5E3)})}
;function bi(a,b,c){c=void 0===c?{}:c;var d=ai;R("ytLoggingEventsDefaultDisabled",!1)&&ai==ai&&(d=null);Og(a,b,d,c)}
;var ci=[{sa:function(a){return"Cannot read property '"+a.key+"'"},
...
groups:["key"]}]}}];var di=new Set,ei=0;function fi(a){gi(a,"WARNING")}
...
(window&&window.yterr||g)&&!(5<=ei)&&0!==a.f)){var h=uc(a);g=h.message||"Unknown Error";d=h.name||"UnknownError";e=h.lineNumber||"Not available";f=h.fileName||"Not available";h=h.stack||a.g||"Not available";if(a.hasOwnProperty("args")&&a.args&&a.args.length)for(var k=0,l=0;l<a.args.length;l++){var m=a.args[l],p="params."+l;k+=p.length;if(m)if(Array.isArray(m))for(var u=c,q=0;q<m.length&&!(m[q]&&(k+=hi(q,m[q],p,u),500<k));q++);else if("object"===typeof m)for(u in u=void 0,q=c,m){if(m[u]&&(k+=hi(u,
m[u],p,q),500<k))break}else c[p]=String(JSON.stringify(m)).substring(0,500),k+=c[p].length;else c[p]=String(JSON.stringify(m)).substring(0,500),k+=c[p].length;if(500<=k)break}else if(a.hasOwnProperty("params")&&a.params)if(m=a.params,"object"===typeof a.params)for(l in p=0,m){if(m[l]&&(k="params."+l,u=String(JSON.stringify(m[l])).substr(0,500),c[k]=u,p+=k.length+u.length,500<p))break}else c.params=String(JSON.stringify(m)).substr(0,500);c={message:g,name:d,lineNumber:e,fileName:f,stack:h,params:c};
a=Number(a.columnNumber);isNaN(a)||(c.lineNumber=c.lineNumber+":"+a);a=t(ci);for(g=a.next();!g.done;g=a.next())if(g=g.value,g.ma[c.name])for(e=t(g.ma[c.name]),d=e.next();!d.done;d=e.next())if(f=d.value,d=c.message.match(f.regexp)){c.params["error.original"]=d[0];e=f.groups;f={};for(h=0;h<e.length;h++)f[e[h]]=d[h+1],c.params["error."+e[h]]=d[h+1];c.message=g.sa(f);break}window.yterr&&"function"===typeof window.yterr&&window.yterr(c);if(!(di.has(c.message)||0<=c.stack.indexOf("/YouTubeCenter.js")||
0<=c.stack.indexOf("/mytube.js"))){if(T("kevlar_gel_error_routing")){g=b;d={stackTrace:c.stack};c.fileName&&(d.filename=c.fileName);a=c.lineNumber&&c.lineNumber.split?c.lineNumber.split(":"):[];0!==a.length&&(1!==a.length||isNaN(Number(a[0]))?2!==a.length||isNaN(Number(a[0]))||isNaN(Number(a[1]))||(d.lineNumber=Number(a[0]),d.columnNumber=Number(a[1])):d.lineNumber=Number(a[0]));a={level:"ERROR_LEVEL_UNKNOWN",message:c.message};"ERROR"===g?a.level="ERROR_LEVEL_ERROR":"WARNING"===g&&(a.level="ERROR_LEVEL_WARNNING");
g={isObfuscated:!0,browserStackInfo:d};d={pageUrl:window.location.href,kvPairs:[]};if(e=c.params)for(f=t(Object.keys(e)),h=f.next();!h.done;h=f.next())h=h.value,d.kvPairs.push({key:"client."+h,value:String(e[h])});bi("clientError",{errorMetadata:d,stackTrace:g,logMessage:a});Fg()}a=c.params||{};b={gb:{a:"logerror",t:"jserror",type:c.name,msg:c.message.substr(0,250),line:c.lineNumber,level:b,"client.name":a.name},D:{url:R("PAGE_NAME",window.location.href),file:c.fileName},method:"POST"};a.version&&
(b["client.version"]=a.version);if(b.D){c.stack&&(b.D.stack=c.stack);g=t(Object.keys(a));for(d=g.next();!d.done;d=g.next())d=d.value,b.D["client."+d]=a[d];if(a=R("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS",void 0))for(g=t(Object.keys(a)),d=g.next();!d.done;d=g.next())d=d.value,b.D[d]=a[d];a=R("SERVER_NAME",void 0);g=R("SERVER_VERSION",void 0);a&&g&&(b.D["server.name"]=a,b.D["server.version"]=g)}df(R("ECATCHER_REPORT_HOST","")+"/error_204",b);di.add(c.message);ei++}}}
function hi(a,b,c,d){c+="."+a;a=String(JSON.stringify(b)).substr(0,500);d[c]=a;return c.length+a.length}
;function ii(){this.g=!1;this.f=null}
ii.prototype.initialize=function(a,b,c,d,e,f){var g=this;f=void 0===f?!1:f;b?(this.g=!0,Mf(b,function(){g.g=!1;window.botguard?ji(g,c,d,f):(Rf(b),fi(new $h("Unable to load Botguard","from "+b)))},e)):a&&(eval(a),window.botguard?ji(this,c,d,f):fi(Error("Unable to load Botguard from JS")))};
function ji(a,b,c,d){if(d)try{a.f=new window.botguard.bg(b,c?function(){return c(b)}:Ha)}catch(e){fi(e)}else{try{a.f=new window.botguard.bg(b)}catch(e){fi(e)}c&&c(b)}}
ii.prototype.dispose=function(){this.f=null};var ki=new ii;function li(){return!!ki.f}
function mi(a){a=void 0===a?{}:a;a=void 0===a?{}:a;return ki.f?ki.f.invoke(void 0,void 0,a):null}
;var ni=D().toString();
function oi(){a:{if(window.crypto&&window.crypto.getRandomValues)try{var a=Array(16),b=new Uint8Array(16);window.crypto.getRandomValues(b);for(var c=0;c<a.length;c++)a[c]=b[c];var d=a;break a}catch(e){}d=Array(16);for(a=0;16>a;a++){b=D();for(c=0;c<b%23;c++)d[a]=Math.random();d[a]=Math.floor(256*Math.random())}if(ni)for(a=1,b=0;b<ni.length;b++)d[a%16]=d[a%16]^d[(a-1)%16]/4^ni.charCodeAt(b),a++}a=[];for(b=0;b<d.length;b++)a.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(d[b]&63));
return a.join("")}
;var pi=y.ytLoggingDocDocumentNonce_||oi();z("ytLoggingDocDocumentNonce_",pi,void 0);var qi=1;function ri(a){this.f=a}
ri.prototype.getAsJson=function(){var a={};void 0!==this.f.trackingParams?a.trackingParams=this.f.trackingParams:(a.veType=this.f.veType,void 0!==this.f.veCounter&&(a.veCounter=this.f.veCounter),void 0!==this.f.elementIndex&&(a.elementIndex=this.f.elementIndex));void 0!==this.f.dataElement&&(a.dataElement=this.f.dataElement.getAsJson());void 0!==this.f.youtubeData&&(a.youtubeData=this.f.youtubeData);return a};
ri.prototype.toString=function(){return JSON.stringify(this.getAsJson())};
ri.prototype.isClientVe=function(){return!this.f.trackingParams&&!!this.f.veType};function si(a){a=void 0===a?0:a;return 0==a?"client-screen-nonce":"client-screen-nonce."+a}
function ti(a){a=void 0===a?0:a;return 0==a?"ROOT_VE_TYPE":"ROOT_VE_TYPE."+a}
function ui(a){return R(ti(void 0===a?0:a),void 0)}
z("yt_logging_screen.getRootVeType",ui,void 0);function vi(){var a=ui(0),b;a?b=new ri({veType:a,youtubeData:void 0}):b=null;return b}
function wi(){var a=R("csn-to-ctt-auth-info");a||(a={},Q("csn-to-ctt-auth-info",a));return a}
function xi(a){a=void 0===a?0:a;var b=R(si(a));if(!b&&!R("USE_CSN_FALLBACK",!0))return null;b||0!=a||(T("kevlar_client_side_screens")||T("c3_client_side_screens")?b="UNDEFINED_CSN":b=R("EVENT_ID"));return b?b:null}
z("yt_logging_screen.getCurrentCsn",xi,void 0);function yi(a,b,c){var d=wi();(c=xi(c))&&delete d[c];b&&(d[a]=b)}
function zi(a){return wi()[a]}
z("yt_logging_screen.getCttAuthInfo",zi,void 0);function Ai(a,b,c,d){c=void 0===c?0:c;if(a!==R(si(c))||b!==R(ti(c)))if(yi(a,d,c),Q(si(c),a),Q(ti(c),b),0==c||T("web_screen_associated_all_layers"))b=function(){setTimeout(function(){a&&Og("foregroundHeartbeatScreenAssociated",{clientDocumentNonce:pi,clientScreenNonce:a},ai)},0)},"requestAnimationFrame"in window?window.requestAnimationFrame(b):b()}
z("yt_logging_screen.setCurrentScreen",Ai,void 0);function Bi(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=R("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=void 0===e?!0:e;var f=R("VALID_SESSION_TEMPDATA_DOMAINS",[]),g=K(window.location.href);g&&f.push(g);g=K(d);if(0<=Ya(f,g)||!g&&0==d.lastIndexOf("/",0))if(T("autoescape_tempdata_url")&&(f=document.createElement("a"),Rb(f,d),d=f.href),d){g=d.match(Wb);d=g[5];f=g[6];g=g[7];var h="";d&&(h+=d);f&&(h+="?"+f);g&&(h+="#"+g);d=h;f=d.indexOf("#");if(d=0>f?d:d.substr(0,f))if(e&&!b.csn&&(b.itct||b.ved)&&
(b=Object.assign({csn:xi()},b)),k){var k=parseInt(k,10);isFinite(k)&&0<k&&(e=b,b="ST-"+Vb(d).toString(36),e=e?Zb(e):"",vf(b,e,k||5))}else k=b,e="ST-"+Vb(d).toString(36),k=k?Zb(k):"",vf(e,k,5)}}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var l=void 0===l?{}:l;var m=void 0===m?"":m;var p=void 0===p?window:p;c=p.location;a=$b(a,l)+m;a=a instanceof I?a:Jb(a);c.href=Hb(a)}return!0}
;function Ci(a,b){this.version=a;this.args=b}
;function Di(a,b){this.topic=a;this.f=b}
Di.prototype.toString=function(){return this.topic};var Ei=A("ytPubsub2Pubsub2Instance")||new P;P.prototype.subscribe=P.prototype.subscribe;P.prototype.unsubscribeByKey=P.prototype.P;P.prototype.publish=P.prototype.O;P.prototype.clear=P.prototype.clear;z("ytPubsub2Pubsub2Instance",Ei,void 0);var Fi=A("ytPubsub2Pubsub2SubscribedKeys")||{};z("ytPubsub2Pubsub2SubscribedKeys",Fi,void 0);var Gi=A("ytPubsub2Pubsub2TopicToKeys")||{};z("ytPubsub2Pubsub2TopicToKeys",Gi,void 0);var Hi=A("ytPubsub2Pubsub2IsAsync")||{};z("ytPubsub2Pubsub2IsAsync",Hi,void 0);
z("ytPubsub2Pubsub2SkipSubKey",null,void 0);function Ii(a,b){var c=Ji();c&&c.publish.call(c,a.toString(),a,b)}
function Ki(a){var b=Li,c=Ji();if(!c)return 0;var d=c.subscribe(b.toString(),function(e,f){var g=A("ytPubsub2Pubsub2SkipSubKey");g&&g==d||(g=function(){if(Fi[d])try{if(f&&b instanceof Di&&b!=e)try{var h=b.f,k=f;if(!k.args||!k.version)throw Error("yt.pubsub2.Data.deserialize(): serializedData is incomplete.");try{if(!h.J){var l=new h;h.J=l.version}var m=h.J}catch(p){}if(!m||k.version!=m)throw Error("yt.pubsub2.Data.deserialize(): serializedData version is incompatible.");try{f=Reflect.construct(h,
db(k.args))}catch(p){throw p.message="yt.pubsub2.Data.deserialize(): "+p.message,p;}}catch(p){throw p.message="yt.pubsub2.pubsub2 cross-binary conversion error for "+b.toString()+": "+p.message,p;}a.call(window,f)}catch(p){S(p)}},Hi[b.toString()]?A("yt.scheduler.instance")?Wf(g):U(g,0):g())});
...
return b}
function Oi(a){var b=Ji();b&&("number"===typeof a&&(a=[a]),H(a,function(c){b.unsubscribeByKey(c);delete Fi[c]}))}
function Ji(){return A("ytPubsub2Pubsub2Instance")}
;function Pi(a){Ci.call(this,1,arguments);this.csn=a}
v(Pi,Ci);var Li=new Di("screen-created",Pi),Qi=[],Ri=0;function Si(a,b,c){var d=T("use_default_events_client")?void 0:ai;b={csn:a,parentVe:b.getAsJson(),childVes:$a(c,function(f){return f.getAsJson()})};
c=t(c);for(var e=c.next();!e.done;e=c.next())e=e.value.getAsJson(),(jb(e)||!e.trackingParams&&!e.veType)&&gi(Error("Child VE logged with no data"),"WARNING",void 0,void 0,!1,void 0);c={fa:zi(a),S:a};"UNDEFINED_CSN"==a?Ti("visualElementAttached",b,c):d?Og("visualElementAttached",b,d,c):bi("visualElementAttached",b,c)}
function Ti(a,b,c){Qi.push({payloadName:a,payload:b,options:c});Ri||(Ri=Mi())}
function Ni(a){if(Qi){for(var b=t(Qi),c=b.next();!c.done;c=b.next())c=c.value,c.payload&&(c.payload.csn=a.csn,Og(c.payloadName,c.payload,null,c.options));Qi.length=0}Ri=0}
;function Ui(a){a=a||{};var b={},c={};this.url=a.url||"";this.args=a.args||mb(b);this.assets=a.assets||{};this.attrs=a.attrs||mb(c);this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
Ui.prototype.clone=function(){var a=new Ui,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];"object"==Ja(c)?a[b]=mb(c):a[b]=c}return a};function Vi(){M.call(this);this.f=[]}
v(Vi,M);Vi.prototype.o=function(){for(;this.f.length;){var a=this.f.pop();a.target.removeEventListener(a.name,a.ub)}M.prototype.o.call(this)};var Wi=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function Xi(a){a=a||"";if(window.spf){var b=a.match(Wi);spf.style.load(a,b?b[1]:"",void 0)}else Yi(a)}
function Yi(a){var b=Zi(a),c=document.getElementById(b),d=c&&yf(c,"loaded");d||c&&!d||(c=$i(a,b,function(){yf(c,"loaded")||(wf(c),Hf(b),U(Ta(If,b),0))}))}
function $i(a,b,c){var d=document.createElement("link");d.id=b;d.onload=function(){c&&setTimeout(c,0)};
a=Lc(a);d.rel="stylesheet";d.href=vb(a).toString();(document.getElementsByTagName("head")[0]||document.body).appendChild(d);return d}
function Zi(a){var b=Hc(document,"A");Rb(b,new I(Fb,a));a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+Vb(a)}
;function aj(a,b,c,d){M.call(this);var e=this;this.m=this.Z=a;this.W=b;this.u=!1;this.api={};this.X=this.G=null;this.H=new P;Sc(this,Ta(Tc,this.H));this.j={};this.T=this.Y=this.h=this.ea=this.f=null;this.K=!1;this.l=this.C=null;this.aa={};this.za=["onReady"];this.da=null;this.na=NaN;this.U={};this.i=d;bj(this);this.ba("WATCH_LATER_VIDEO_ADDED",this.Ra.bind(this));this.ba("WATCH_LATER_VIDEO_REMOVED",this.Sa.bind(this));this.ba("onAdAnnounce",this.Ba.bind(this));this.Aa=new Vi(this);Sc(this,Ta(Tc,this.Aa));
this.V=0;c?this.V=U(function(){e.loadNewVideoConfig(c)},0):d&&(cj(this),dj(this))}
v(aj,M);n=aj.prototype;n.getId=function(){return this.W};
n.loadNewVideoConfig=function(a){if(!this.g){this.V&&(Ve(this.V),this.V=0);a instanceof Ui||(a=new Ui(a));this.ea=a;this.f=a.clone();cj(this);this.Y||(this.Y=ej(this,this.f.args.jsapicallback||"onYouTubePlayerReady"));this.f.args.jsapicallback=null;if(a=this.f.attrs.width)this.m.style.width=Vc(Number(a)||a);if(a=this.f.attrs.height)this.m.style.height=Vc(Number(a)||a);dj(this);this.u&&fj(this)}};
function cj(a){var b;a.i?b=a.i.rootElementId:b=a.f.attrs.id;a.h=b||a.h;"video-player"==a.h&&(a.h=a.W,a.f.attrs.id=a.W);a.m.id==a.h&&(a.h+="-player",a.f.attrs.id=a.h)}
n.Fa=function(){return this.ea};
function fj(a){a.f&&!a.f.loaded&&(a.f.loaded=!0,"0"!=a.f.args.autoplay?a.api.loadVideoByPlayerVars(a.f.args):a.api.cueVideoByPlayerVars(a.f.args))}
function gj(a){var b=!0,c=hj(a);c&&a.f&&(a=ij(a),b=yf(c,"version")===a);return b&&!!A("yt.player.Application.create")}
function dj(a){if(!a.g&&!a.K){var b=gj(a);if(b&&"html5"==(hj(a)?"html5":null))a.T="html5",a.u||jj(a);else if(kj(a),a.T="html5",b&&a.l)a.Z.appendChild(a.l),jj(a);else{a.f&&(a.f.loaded=!0);var c=!1;a.C=function(){c=!0;if(a.i)var d=a.i.serializedExperimentFlags;else a.f&&a.f.args&&(d=a.f.args.fflags);d="true"==Ie(d||"").player_bootstrap_method?A("yt.player.Application.createAlternate")||A("yt.player.Application.create"):A("yt.player.Application.create");var e=a.f?a.f.clone():void 0;d(a.Z,e,a.i);jj(a)};
a.K=!0;b?a.C():(Mf(ij(a),a.C),(b=a.i?a.i.cssUrl:a.f.assets.css)&&Xi(b),lj(a)&&!c&&z("yt.player.Application.create",null,void 0))}}}
function hj(a){var b=Dc(a.h);!b&&a.m&&a.m.querySelector&&(b=a.m.querySelector("#"+a.h));return b}
function jj(a){if(!a.g){var b=hj(a),c=!1;b&&b.getApiInterface&&b.getApiInterface()&&(c=!0);c?(a.K=!1,b.isNotServable&&a.f&&b.isNotServable(a.f.args.video_id)||mj(a)):a.na=U(function(){jj(a)},50)}}
function mj(a){bj(a);a.u=!0;var b=hj(a);b.addEventListener&&(a.G=nj(a,b,"addEventListener"));b.removeEventListener&&(a.X=nj(a,b,"removeEventListener"));var c=b.getApiInterface();c=c.concat(b.getInternalApiInterface());for(var d=0;d<c.length;d++){var e=c[d];a.api[e]||(a.api[e]=nj(a,b,e))}for(var f in a.j)a.G(f,a.j[f]);fj(a);a.Y&&a.Y(a.api);a.H.O("onReady",a.api)}
function nj(a,b,c){var d=b[c];return function(){try{return a.da=null,d.apply(b,arguments)}catch(e){"sendAbandonmentPing"!=c&&(e.params=c,a.da=e,He(e))}}}
function bj(a){a.u=!1;if(a.X)for(var b in a.j)a.X(b,a.j[b]);for(var c in a.U)Ve(parseInt(c,10));a.U={};a.G=null;a.X=null;for(var d in a.api)a.api[d]=null;a.api.addEventListener=a.ba.bind(a);a.api.removeEventListener=a.Wa.bind(a);a.api.destroy=a.dispose.bind(a);a.api.getLastError=a.Ga.bind(a);a.api.getPlayerType=a.Ha.bind(a);a.api.getCurrentVideoConfig=a.Fa.bind(a);a.api.loadNewVideoConfig=a.loadNewVideoConfig.bind(a);a.api.isReady=a.Qa.bind(a)}
n.Qa=function(){return this.u};
n.ba=function(a,b){var c=this,d=ej(this,b);if(d){if(!(0<=Ya(this.za,a)||this.j[a])){var e=oj(this,a);this.G&&this.G(a,e)}this.H.subscribe(a,d);"onReady"==a&&this.u&&U(function(){d(c.api)},0)}};
n.Wa=function(a,b){if(!this.g){var c=ej(this,b);c&&ge(this.H,a,c)}};
function ej(a,b){var c=b;if("string"==typeof b){if(a.aa[b])return a.aa[b];c=function(){var d=A(b);d&&d.apply(y,arguments)};
a.aa[b]=c}return c?c:null}
function oj(a,b){var c="ytPlayer"+b+a.W;a.j[b]=c;y[c]=function(d){var e=U(function(){if(!a.g){a.H.O(b,d);var f=a.U,g=String(e);g in f&&delete f[g]}},0);
kb(a.U,String(e))};
return c}
...
n.Ha=function(){return this.T||(hj(this)?"html5":null)};
n.Ga=function(){return this.da};
function kj(a){a.cancel();bj(a);a.T=null;a.f&&(a.f.loaded=!1);var b=hj(a);b&&(gj(a)||!lj(a)?a.l=b:(b&&b.destroy&&b.destroy(),a.l=null));for(a=a.Z;b=a.firstChild;)a.removeChild(b)}
n.cancel=function(){if(this.C){var a=ij(this);Sf(a,this.C)}Ve(this.na);this.K=!1};
n.o=function(){kj(this);if(this.l&&this.f&&this.l.destroy)try{this.l.destroy()}catch(b){S(b)}this.aa=null;for(var a in this.j)y[this.j[a]]=null;this.ea=this.f=this.api=null;delete this.Z;delete this.m;M.prototype.o.call(this)};
function lj(a){return a.f&&a.f.args&&a.f.args.fflags?-1!=a.f.args.fflags.indexOf("player_destroy_old_version=true"):!1}
function ij(a){return a.i?a.i.jsUrl:a.f.assets.js}
;var pj={},qj="player_uid_"+(1E9*Math.random()>>>0);function rj(a){delete pj[a.getId()]}
;function sj(a){return(0===a.search("cue")||0===a.search("load"))&&"loadModule"!==a}
function tj(a,b,c){"string"===typeof a&&(a={mediaContentUrl:a,startSeconds:b,suggestedQuality:c});a:{if((b=a.mediaContentUrl)&&(b=/\/([ve]|embed)\/([^#?]+)/.exec(b))&&b[2]){b=b[2];break a}b=null}a.videoId=b;return uj(a)}
function uj(a,b,c){if("string"===typeof a)return{videoId:a,startSeconds:b,suggestedQuality:c};b=["endSeconds","startSeconds","mediaContentUrl","suggestedQuality","videoId"];c={};for(var d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}
function vj(a,b,c,d){if(Ma(a)&&!Array.isArray(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}b={index:b,startSeconds:c,suggestedQuality:d};"string"===typeof a&&16===a.length?b.list="PL"+a:b.playlist=a;return b}
;function wj(a){a=void 0===a?!1:a;M.call(this);this.f=new P(a);Sc(this,Ta(Tc,this.f))}
F(wj,M);wj.prototype.subscribe=function(a,b,c){return this.g?0:this.f.subscribe(a,b,c)};
wj.prototype.j=function(a,b){this.g||this.f.O.apply(this.f,arguments)};function xj(a,b,c){wj.call(this);this.h=a;this.i=b;this.l=c}
v(xj,wj);function yj(a,b,c){if(!a.g){var d=a.h;d.g||a.i!=d.f||(a={id:a.l,command:b},c&&(a.data=c),d.f.postMessage(Id(a),d.i))}}
xj.prototype.o=function(){this.i=this.h=null;wj.prototype.o.call(this)};function zj(a){M.call(this);this.f=a;this.f.subscribe("command",this.xa,this);this.h={};this.j=!1}
v(zj,M);n=zj.prototype;n.start=function(){this.j||this.g||(this.j=!0,yj(this.f,"RECEIVING"))};
n.xa=function(a,b,c){if(this.j&&!this.g){var d=b||{};switch(a){case "addEventListener":"string"===typeof d.event&&(a=d.event,a in this.h||(c=C(this.Ya,this,a),this.h[a]=c,this.addEventListener(a,c)));break;case "removeEventListener":"string"===typeof d.event&&Aj(this,d.event);break;default:this.i.isReady()&&this.i.isExternalMethodAvailable(a,c||null)&&(b=Bj(a,b||{}),c=this.i.handleExternalCall(a,b,c||null),(c=Cj(a,c))&&this.j&&!this.g&&yj(this.f,a,c))}}};
n.Ya=function(a,b){this.j&&!this.g&&yj(this.f,a,this.ha(a,b))};
n.ha=function(a,b){if(null!=b)return{value:b}};
function Aj(a,b){b in a.h&&(a.removeEventListener(b,a.h[b]),delete a.h[b])}
n.o=function(){var a=this.f;a.g||ge(a.f,"command",this.xa,this);this.f=null;for(var b in this.h)Aj(this,b);M.prototype.o.call(this)};function Dj(a,b){zj.call(this,b);this.i=a;this.start()}
v(Dj,zj);Dj.prototype.addEventListener=function(a,b){this.i.addEventListener(a,b)};
Dj.prototype.removeEventListener=function(a,b){this.i.removeEventListener(a,b)};
function Bj(a,b){switch(a){case "loadVideoById":return b=uj(b),[b];case "cueVideoById":return b=uj(b),[b];case "loadVideoByPlayerVars":return[b];case "cueVideoByPlayerVars":return[b];case "loadPlaylist":return b=vj(b),[b];case "cuePlaylist":return b=vj(b),[b];case "seekTo":return[b.seconds,b.allowSeekAhead];case "playVideoAt":return[b.index];case "setVolume":return[b.volume];case "setPlaybackQuality":return[b.suggestedQuality];case "setPlaybackRate":return[b.suggestedRate];case "setLoop":return[b.loopPlaylists];
...
Dj.prototype.ha=function(a,b){switch(a){case "onReady":return;case "onStateChange":return{playerState:b};case "onPlaybackQualityChange":return{playbackQuality:b};case "onPlaybackRateChange":return{playbackRate:b};case "onError":return{errorCode:b}}return zj.prototype.ha.call(this,a,b)};
Dj.prototype.o=function(){zj.prototype.o.call(this);delete this.i};function Ej(a,b,c){M.call(this);var d=this;c=c||R("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname;this.h=b||null;this.u="*";this.i=c;this.sessionId=null;this.channel="widget";this.C=!!a;this.m=function(e){a:if(!("*"!=d.i&&e.origin!=d.i||d.h&&e.source!=d.h||"string"!==typeof e.data)){try{var f=JSON.parse(e.data)}catch(g){break a}if(!(null==f||d.C&&(d.sessionId&&d.sessionId!=f.id||d.channel&&d.channel!=f.channel))&&f)switch(f.event){case "listening":"null"!=
...
v(Ej,M);Ej.prototype.sendMessage=function(a,b){var c=b||this.h;if(c){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var d=JSON.stringify(a);c.postMessage(d,this.u)}catch(e){He(e)}}};
Ej.prototype.o=function(){window.removeEventListener("message",this.m);M.prototype.o.call(this)};function Fj(){var a=this.g=new Ej(!!R("WIDGET_ID_ENFORCE")),b=C(this.Va,this);a.j=b;a.l=null;this.g.channel="widget";if(a=R("WIDGET_ID"))this.g.sessionId=a;this.i=[];this.l=!1;this.j={}}
n=Fj.prototype;n.Va=function(a,b,c){"addEventListener"==a&&b?(a=b[0],this.j[a]||"onReady"==a||(this.addEventListener(a,Gj(this,a)),this.j[a]=!0)):this.ta(a,b,c)};
n.ta=function(){};
function Gj(a,b){return C(function(c){this.sendMessage(b,c)},a)}
...
n.dispose=function(){this.g=null};function Ij(a){Fj.call(this);this.f=a;this.h=[];this.addEventListener("onReady",C(this.Ta,this));this.addEventListener("onVideoProgress",C(this.cb,this));this.addEventListener("onVolumeChange",C(this.eb,this));this.addEventListener("onApiChange",C(this.Xa,this));this.addEventListener("onPlaybackQualityChange",C(this.Za,this));this.addEventListener("onPlaybackRateChange",C(this.ab,this));this.addEventListener("onStateChange",C(this.bb,this));this.addEventListener("onWebglSettingsChanged",C(this.fb,
this))}
v(Ij,Fj);n=Ij.prototype;n.ta=function(a,b,c){if(this.f.isExternalMethodAvailable(a,c)){b=b||[];if(0<b.length&&sj(a)){var d=b;if(Ma(d[0])&&!Array.isArray(d[0]))d=d[0];else{var e={};switch(a){case "loadVideoById":case "cueVideoById":e=uj.apply(window,d);break;case "loadVideoByUrl":case "cueVideoByUrl":e=tj.apply(window,d);break;case "loadPlaylist":case "cuePlaylist":e=vj.apply(window,d)}d=e}b.length=1;b[0]=d}this.f.handleExternalCall(a,b,c);sj(a)&&Hj(this,this.ia())}};
...
this.f.getVideoUrl());this.f.getVideoContentRect&&(a.videoContentRect=this.f.getVideoContentRect());this.f.getProgressState&&(a.progressState=this.f.getProgressState());this.f.getPlaylist&&(a.playlist=this.f.getPlaylist());this.f.getPlaylistIndex&&(a.playlistIndex=this.f.getPlaylistIndex());this.f.getStoryboardFormat&&(a.storyboardFormat=this.f.getStoryboardFormat());Hj(this,a)};
n.Za=function(a){Hj(this,{playbackQuality:a})};
n.ab=function(a){Hj(this,{playbackRate:a})};
...
n.eb=function(){Hj(this,{muted:this.f.isMuted(),volume:this.f.getVolume()})};
n.cb=function(a){a={currentTime:a,videoBytesLoaded:this.f.getVideoBytesLoaded(),videoLoadedFraction:this.f.getVideoLoadedFraction(),currentTimeLastUpdated_:D()/1E3,playbackRate:this.f.getPlaybackRate(),mediaReferenceTime:this.f.getMediaReferenceTime()};this.f.getProgressState&&(a.progressState=this.f.getProgressState());Hj(this,a)};
n.fb=function(){var a={sphericalProperties:this.f.getSphericalProperties()};Hj(this,a)};
n.dispose=function(){Fj.prototype.dispose.call(this);for(var a=0;a<this.h.length;a++){var b=this.h[a];this.f.removeEventListener(b.eventType,b.listener)}this.h=[]};function Jj(a,b,c){M.call(this);this.f=a;this.i=c;this.j=jg(window,"message",C(this.l,this));this.h=new xj(this,a,b);Sc(this,Ta(Tc,this.h))}
v(Jj,M);Jj.prototype.l=function(a){var b;if(b=!this.g)if(b=a.origin==this.i)a:{b=this.f;do{b:{var c=a.source;do{if(c==b){c=!0;break b}if(c==c.parent)break;c=c.parent}while(null!=c);c=!1}if(c){b=!0;break a}b=b.opener}while(null!=b);b=!1}if(b&&(b=a.data,"string"===typeof b)){try{b=JSON.parse(b)}catch(d){return}b.command&&(c=this.h,c.g||c.j("command",b.command,b.data,a.origin))}};
Jj.prototype.o=function(){kg(this.j);this.f=null;M.prototype.o.call(this)};function Kj(){var a=mb(Lj),b;return Wd(new O(function(c,d){a.onSuccess=function(e){Ue(e)?c(e):d(new Mj("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
a.onError=function(e){d(new Mj("Unknown request error","net.unknown",e))};
a.R=function(e){d(new Mj("Request timed out","net.timeout",e))};
b=df("//googleads.g.doubleclick.net/pagead/id",a)}),function(c){c instanceof Xd&&b.abort();
return Ud(c)})}
function Mj(a,b){G.call(this,a+", errorCode="+b);this.errorCode=b;this.name="PromiseAjaxError"}
v(Mj,G);function Nj(){this.g=0;this.f=null}
Nj.prototype.then=function(a,b,c){return 1===this.g&&a?(a=a.call(c,this.f),Od(a)?a:Oj(a)):2===this.g&&b?(a=b.call(c,this.f),Od(a)?a:Pj(a)):this};
Nj.prototype.getValue=function(){return this.f};
Nj.prototype.$goog_Thenable=!0;function Pj(a){var b=new Nj;a=void 0===a?null:a;b.g=2;b.f=void 0===a?null:a;return b}
function Oj(a){var b=new Nj;a=void 0===a?null:a;b.g=1;b.f=void 0===a?null:a;return b}
;function Qj(a){G.call(this,a.message||a.description||a.name);this.isMissing=a instanceof Rj;this.isTimeout=a instanceof Mj&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof Xd}
v(Qj,G);Qj.prototype.name="BiscottiError";function Rj(){G.call(this,"Biscotti ID is missing from server")}
v(Rj,G);Rj.prototype.name="BiscottiMissingError";var Lj={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},Sj=null;
function Ce(){if(T("disable_biscotti_fetch_on_html5_clients"))return Ud(Error("Fetching biscotti ID is disabled."));if(T("condition_biscotti_fetch_on_consent_cookie_html5_clients")&&!zc.get("CONSENT","").startsWith("YES+"))return Ud(Error("User has not consented - not fetching biscotti id."));if("1"===gb(ze(),"args","privembed"))return Ud(Error("Biscotti ID is not available in private embed mode"));Sj||(Sj=Wd(Kj().then(Tj),function(a){return Uj(2,a)}));
return Sj}
function Tj(a){a=a.responseText;if(0!=a.lastIndexOf(")]}'",0))throw new Rj;a=JSON.parse(a.substr(4));if(1<(a.type||1))throw new Rj;a=a.id;De(a);Sj=Oj(a);Vj(18E5,2);return a}
function Uj(a,b){var c=new Qj(b);De("");Sj=Pj(c);0<a&&Vj(12E4,a-1);throw c;}
function Vj(a,b){U(function(){Wd(Kj().then(Tj,function(c){return Uj(b,c)}),Ha)},a)}
function Wj(){try{var a=A("yt.ads.biscotti.getId_");return a?a():Ce()}catch(b){return Ud(b)}}
;function Xj(a){if("1"!==gb(ze(),"args","privembed")){a&&Be();try{Wj().then(function(){},function(){}),U(Xj,18E5)}catch(b){S(b)}}}
;var Y=A("ytglobal.prefsUserPrefsPrefs_")||{};z("ytglobal.prefsUserPrefsPrefs_",Y,void 0);function Yj(){this.f=R("ALT_PREF_COOKIE_NAME","PREF");var a=zc.get(""+this.f,void 0);if(a){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Y[d]=c.toString())}}}
n=Yj.prototype;n.get=function(a,b){Zj(a);ak(a);var c=void 0!==Y[a]?Y[a].toString():null;return null!=c?c:b?b:""};
n.set=function(a,b){Zj(a);ak(a);if(null==b)throw Error("ExpectedNotNull");Y[a]=b.toString()};
n.remove=function(a){Zj(a);ak(a);delete Y[a]};
...
function ak(a){if(/^f([1-9][0-9]*)$/.test(a))throw Error("ExpectedRegexMatch: "+a);}
function Zj(a){if(!/^\w+$/.test(a))throw Error("ExpectedRegexMismatch: "+a);}
function bk(a){a=void 0!==Y[a]?Y[a].toString():null;return null!=a&&/^[A-Fa-f0-9]+$/.test(a)?parseInt(a,16):null}
Ia(Yj);function ck(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];if(!dk(a)||c.some(function(e){return!dk(e)}))throw Error("Only objects may be merged.");
c=t(c);for(d=c.next();!d.done;d=c.next())ek(a,d.value);return a}
function ek(a,b){for(var c in b)if(dk(b[c])){if(c in a&&!dk(a[c]))throw Error("Cannot merge an object into a non-object.");c in a||(a[c]={});ek(a[c],b[c])}else if(fk(b[c])){if(c in a&&!fk(a[c]))throw Error("Cannot merge an array into a non-array.");c in a||(a[c]=[]);gk(a[c],b[c])}else a[c]=b[c];return a}
function gk(a,b){for(var c=t(b),d=c.next();!d.done;d=c.next())d=d.value,dk(d)?a.push(ek({},d)):fk(d)?a.push(gk([],d)):a.push(d);return a}
function dk(a){return"object"===typeof a&&!Array.isArray(a)}
function fk(a){return"object"===typeof a&&Array.isArray(a)}
;function hk(a,b){Ci.call(this,1,arguments)}
v(hk,Ci);function ik(a,b){Ci.call(this,1,arguments)}
v(ik,Ci);var jk=new Di("aft-recorded",hk),kk=new Di("timing-sent",ik);var lk=window;function mk(){this.timing={};this.clearResourceTimings=function(){};
this.webkitClearResourceTimings=function(){};
this.mozClearResourceTimings=function(){};
this.msClearResourceTimings=function(){};
this.oClearResourceTimings=function(){}}
var nk=lk.performance||lk.mozPerformance||lk.msPerformance||lk.webkitPerformance||new mk;var ok=!1;C(nk.clearResourceTimings||nk.webkitClearResourceTimings||nk.mozClearResourceTimings||nk.msClearResourceTimings||nk.oClearResourceTimings||Ha,nk);function pk(a){var b=qk(a);if(b.aft)return b.aft;a=R((a||"")+"TIMING_AFT_KEYS",["ol"]);for(var c=a.length,d=0;d<c;d++){var e=b[a[d]];if(e)return e}return NaN}
function rk(a){var b;(b=A("ytcsi."+(a||"")+"data_"))||(b={tick:{},info:{}},Ua("ytcsi."+(a||"")+"data_",b));return b}
function sk(a){a=rk(a);a.info||(a.info={});return a.info}
function qk(a){a=rk(a);a.tick||(a.tick={});return a.tick}
function tk(a){var b=rk(a).nonce;b||(b=oi(),rk(a).nonce=b);return b}
function uk(a){var b=qk(a||""),c=pk(a);c&&!ok&&(Ii(jk,new hk(Math.round(c-b._start),a)),ok=!0)}
;function vk(){var a=A("ytcsi.debug");a||(a=[],z("ytcsi.debug",a,void 0),z("ytcsi.reference",{},void 0));return a}
function wk(a){a=a||"";var b=A("ytcsi.reference");b||(vk(),b=A("ytcsi.reference"));if(b[a])return b[a];var c=vk(),d={timerName:a,info:{},tick:{},span:{}};c.push(d);return b[a]=d}
;var xk=y.ytLoggingLatencyUsageStats_||{};z("ytLoggingLatencyUsageStats_",xk,void 0);function yk(){this.f=0}
function zk(){yk.f||(yk.f=new yk);return yk.f}
yk.prototype.tick=function(a,b,c){Ak(this,"tick_"+a+"_"+b)||bi("latencyActionTicked",{tickName:a,clientActionNonce:b},{timestamp:c})};
yk.prototype.info=function(a,b){var c=Object.keys(a).join("");Ak(this,"info_"+c+"_"+b)||(c=Object.assign({},a),c.clientActionNonce=b,bi("latencyActionInfo",c))};
yk.prototype.span=function(a,b){var c=Object.keys(a).join("");Ak(this,"span_"+c+"_"+b)||(a.clientActionNonce=b,bi("latencyActionSpan",a))};
function Ak(a,b){xk[b]=xk[b]||{count:0};var c=xk[b];c.count++;c.time=W();a.f||(a.f=Uf(function(){var d=W(),e;for(e in xk)xk[e]&&6E4<d-xk[e].time&&delete xk[e];a&&(a.f=0)},5E3));
return 5<c.count?(6===c.count&&1>1E5*Math.random()&&(c=new $h("CSI data exceeded logging limit with key",b.split("_")),0<=b.indexOf("plev")||fi(c)),!0):!1}
;var Z={},Bk=(Z.ad_allowed="adTypesAllowed",Z.yt_abt="adBreakType",Z.ad_cpn="adClientPlaybackNonce",Z.ad_docid="adVideoId",Z.yt_ad_an="adNetworks",Z.ad_at="adType",Z.browse_id="browseId",Z.p="httpProtocol",Z.t="transportProtocol",Z.cpn="clientPlaybackNonce",Z.ccs="creatorInfo.creatorCanaryState",Z.cseg="creatorInfo.creatorSegment",Z.csn="clientScreenNonce",Z.docid="videoId",Z.GetHome_rid="requestIds",Z.GetSearch_rid="requestIds",Z.GetPlayer_rid="requestIds",Z.GetWatchNext_rid="requestIds",Z.GetBrowse_rid=
...
Z.GetSettings_rid="requestIds",Z.GetTrending_rid="requestIds",Z.GetMusicSearchSuggestions_rid="requestIds",Z.REQUEST_ID="requestIds",Z),Ck="isContinuation isNavigation kabukiInfo.earlyBrowseRequestInfo.adopted kabukiInfo.isPrefetch kabukiInfo.isSecondaryNav isMonetized navigationRequestedSameUrl performanceNavigationTiming playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber tvInfo.isMdx tvInfo.isPreloaded isVisible watchInfo.isPlaylist playbackRequiresTap".split(" "),Dk={},Ek=(Dk.ccs="CANARY_STATE_",
Dk.mver="MEASUREMENT_VERSION_",Dk.pis="PLAYER_INITIALIZED_STATE_",Dk.yt_pt="LATENCY_PLAYER_",Dk.pa="LATENCY_ACTION_",Dk.yt_vst="VIDEO_STREAM_TYPE_",Dk),Fk="all_vc ap c cver cbrand cmodel cplatform ctheme ei l_an l_mm plid srt yt_fss yt_li vpst vpni2 vpil2 icrc icrt pa GetAccountOverview_rid GetHistory_rid cmt d_vpct d_vpnfi d_vpni nsru pc pfa pfeh pftr pnc prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis ytu_pvis yt_ref yt_sts tds".split(" ");
function Gk(a){return!!R("FORCE_CSI_ON_GEL",!1)||T("csi_on_gel")||!!rk(a).useGel}
function Hk(a){a=rk(a);if(!("gel"in a))a.gel={gelTicks:{},gelInfos:{}};else if(a.gel){var b=a.gel;b.gelInfos||(b.gelInfos={});b.gelTicks||(b.gelTicks={})}return a.gel}
;function Ik(a,b,c){if(null!==b)if(sk(c)[a]=b,Gk(c)){var d=b;b=Hk(c);if(b.gelInfos)b.gelInfos["info_"+a]=!0;else{var e={};b.gelInfos=(e["info_"+a]=!0,e)}if(a.match("_rid")){var f=a.split("_rid")[0];a="REQUEST_ID"}if(a in Bk){b=Bk[a];0<=Ya(Ck,b)&&(d=!!d);a in Ek&&"string"===typeof d&&(d=Ek[a]+d.toUpperCase());a=d;d=b.split(".");for(var g=e={},h=0;h<d.length-1;h++){var k=d[h];g[k]={};g=g[k]}g[d[d.length-1]]="requestIds"===b?[{id:a,endpoint:f}]:a;f=ck({},e)}else 0<=Ya(Fk,a)||fi(new $h("Unknown label logged with GEL CSI",
a)),f=void 0;f&&Gk(c)&&(b=wk(c||""),ck(b.info,f),b=Hk(c),"gelInfos"in b||(b.gelInfos={}),ck(b.gelInfos,f),c=tk(c),zk().info(f,c))}else wk(c||"").info[a]=b}
function Jk(a,b,c){var d=qk(c);if(T("use_first_tick")&&Kk(a,c))return d[a];if(!b&&"_"!==a[0]){var e=a;nk.mark&&(0==e.lastIndexOf("mark_",0)||(e="mark_"+e),c&&(e+=" ("+c+")"),nk.mark(e))}e=b||W();d[a]=e;e=Hk(c);e.gelTicks&&(e.gelTicks["tick_"+a]=!0);c||b||W();if(Gk(c)){wk(c||"").tick[a]=b||W();e=tk(c);if("_start"===a){var f=zk();Ak(f,"baseline_"+e)||bi("latencyActionBaselined",{clientActionNonce:e},{timestamp:b})}else zk().tick(a,e,b);uk(c);e=!0}else e=!1;if(!e){if(!A("yt.timing."+(c||"")+"pingSent_")&&
(f=R((c||"")+"TIMING_ACTION",void 0),e=qk(c),A("ytglobal.timing"+(c||"")+"ready_")&&f&&Kk("_start")&&pk(c)))if(uk(c),c)Lk(c);else{f=!0;var g=R("TIMING_WAIT",[]);if(g.length)for(var h=0,k=g.length;h<k;++h)if(!(g[h]in e)){f=!1;break}f&&Lk(c)}wk(c||"").tick[a]=b||W()}return d[a]}
function Kk(a,b){var c=qk(b);return a in c}
function Lk(a){if(!Gk(a)){var b=qk(a),c=sk(a),d=b._start,e=R("CSI_SERVICE_NAME","youtube"),f={v:2,s:e,action:R((a||"")+"TIMING_ACTION",void 0)},g=c.srt;void 0!==b.srt&&delete c.srt;b.aft=pk(a);var h=qk(a),k=h.pbr,l=h.vc;h=h.pbs;k&&l&&h&&k<l&&l<h&&sk(a).yt_pvis&&"youtube"===e&&(Ik("yt_lt","hot_bg",a),e=b.vc,k=b.pbs,delete b.aft,c.aft=Math.round(k-e));for(var m in c)"_"!==m.charAt(0)&&(f[m]=c[m]);b.ps=W();m={};e=[];for(var p in b)"_"!==p.charAt(0)&&(k=Math.round(b[p]-d),m[p]=k,e.push(p+"."+k));f.rt=
e.join(",");b=!!c.ap;T("debug_csi_data")&&(c=A("yt.timing.csiData"),c||(c=[],Ua("yt.timing.csiData",c)),c.push({page:location.href,time:new Date,args:f}));c="";for(var u in f)f.hasOwnProperty(u)&&(c+="&"+u+"="+f[u]);f="/csi_204?"+c.substring(1);if(window.navigator&&window.navigator.sendBeacon&&b){var q=void 0===q?"":q;sf(f,q)||pf(f,void 0,void 0,void 0,q)}else pf(f);z("yt.timing."+(a||"")+"pingSent_",!0,void 0);Ii(kk,new ik(m.aft+(Number(g)||0),a))}}
if(T("overwrite_polyfill_on_logging_lib_loaded")){var Mk=window;Mk.ytcsi&&(Mk.ytcsi.info=Ik,Mk.ytcsi.tick=Jk)};var Nk=null,Ok=null,Pk=null,Qk={};function Rk(a){var b=a.id;a=a.ve_type;var c=qi++;a=new ri({veType:a,veCounter:c,elementIndex:void 0,dataElement:void 0,youtubeData:void 0});Qk[b]=a;b=xi();c=vi();b&&c&&Si(b,c,[a])}
function Sk(a){var b=a.csn;a=a.root_ve_type;if(b&&a&&(Ai(b,a),a=vi()))for(var c in Qk){var d=Qk[c];d&&Si(b,a,[d])}}
function Tk(a){Qk[a.id]=new ri({trackingParams:a.tracking_params})}
function Uk(a){var b=xi(),c=Qk[a.id];if(b&&c){a=T("use_default_events_client")?void 0:ai;var d="INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK";c={csn:b,ve:c.getAsJson(),gestureType:d};d={fa:zi(b),S:b};"UNDEFINED_CSN"==b?Ti("visualElementGestured",c,d):a?Og("visualElementGestured",c,a,d):bi("visualElementGestured",c,d)}}
function Vk(a){a=a.ids;var b=xi();if(b)for(var c=0;c<a.length;c++){var d=Qk[a[c]];if(d){var e=b,f=T("use_default_events_client")?void 0:ai;d={csn:e,ve:d.getAsJson(),eventType:1};var g={fa:zi(e),S:e};"UNDEFINED_CSN"==e?Ti("visualElementShown",d,g):f?Og("visualElementShown",d,f,g):bi("visualElementShown",d,g)}}}
;z("yt.setConfig",Q,void 0);z("yt.config.set",Q,void 0);z("yt.setMsg",uf,void 0);z("yt.msgs.set",uf,void 0);z("yt.logging.errors.log",gi,void 0);
z("writeEmbed",function(){var a=R("PLAYER_CONFIG",void 0);Xj(!0);"gvn"==a.args.ps&&(document.body.style.backgroundColor="transparent");var b=document.referrer,c=R("POST_MESSAGE_ORIGIN");window!=window.top&&b&&b!=document.URL&&(a.args.loaderUrl=b);R("LIGHTWEIGHT_AUTOPLAY")&&(a.args.autoplay="1");b="player";var d=void 0===d?!0:d;b="string"===typeof b?Dc(b):b;var e=qj+"_"+Na(b),f=pj[e];f&&d?a&&a.args&&a.args.fflags&&a.args.fflags.includes("web_player_remove_playerproxy=true")?f.api.loadVideoByPlayerVars(a.args||
null):f.loadNewVideoConfig(a):(f=new aj(b,e,a,void 0),pj[e]=f,Hf("player-added",f.api),Sc(f,Ta(rj,f)));a=f.api;Nk=a;a.addEventListener("onScreenChanged",Sk);a.addEventListener("onLogClientVeCreated",Rk);a.addEventListener("onLogServerVeCreated",Tk);a.addEventListener("onLogVeClicked",Uk);a.addEventListener("onLogVesShown",Vk);d=R("POST_MESSAGE_ID","player");R("ENABLE_JS_API")?Pk=new Ij(a):R("ENABLE_POST_API")&&"string"===typeof d&&"string"===typeof c&&(Ok=new Jj(window.parent,d,c),Pk=new Dj(a,Ok.h));
ag()},void 0);
z("yt.www.watch.ads.restrictioncookie.spr",function(a){pf(a+"mac_204?action_fcts=1");return!0},void 0);
var Wk=Ge(function(){Jk("ol");var a=Yj.getInstance(),b=!!((bk("f"+(Math.floor(119/31)+1))||0)&67108864),c=1<window.devicePixelRatio;if(document.body&&Gd(document.body,"exp-invert-logo"))if(c&&!Gd(document.body,"inverted-hdpi")){var d=document.body;if(d.classList)d.classList.add("inverted-hdpi");else if(!Gd(d,"inverted-hdpi")){var e=Ed(d);Fd(d,e+(0<e.length?" inverted-hdpi":"inverted-hdpi"))}}else!c&&Gd(document.body,"inverted-hdpi")&&Hd();b!=c&&(b="f"+(Math.floor(119/31)+1),d=bk(b)||0,d=c?d|67108864:
d&-67108865,0==d?delete Y[b]:(c=d.toString(16),Y[b]=c.toString()),a.save())}),Xk=Ge(function(){var a=Nk;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();R("PL_ATT")&&ki.dispose();a=0;for(var b=Zf.length;a<b;a++)Yf(Zf[a]);Zf.length=0;Rf("//static.doubleclick.net/instream/ad_status.js");$f=!1;Q("DCLKSTAT",0);Uc(Pk,Ok);if(a=Nk)a.removeEventListener("onScreenChanged",Sk),a.removeEventListener("onLogClientVeCreated",Rk),a.removeEventListener("onLogServerVeCreated",Tk),a.removeEventListener("onLogVeClicked",Uk),a.removeEventListener("onLogVesShown",Vk),a.destroy();Qk={}});
window.addEventListener?(window.addEventListener("load",Wk),window.addEventListener("unload",Xk)):window.attachEvent&&(window.attachEvent("onload",Wk),window.attachEvent("onunload",Xk));Ua("yt.abuse.player.botguardInitialized",A("yt.abuse.player.botguardInitialized")||li);Ua("yt.abuse.player.invokeBotguard",A("yt.abuse.player.invokeBotguard")||mi);Ua("yt.abuse.dclkstatus.checkDclkStatus",A("yt.abuse.dclkstatus.checkDclkStatus")||bg);
Ua("yt.player.exports.navigate",A("yt.player.exports.navigate")||Bi);Ua("yt.util.activity.init",A("yt.util.activity.init")||og);Ua("yt.util.activity.getTimeSinceActive",A("yt.util.activity.getTimeSinceActive")||rg);Ua("yt.util.activity.setTimestamp",A("yt.util.activity.setTimestamp")||pg);}).call(this);
