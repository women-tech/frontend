  ...
  private ponentes:any[]=[
    {
        ...
        descripcion:"Estudiante de 7mo semestre de la carrera de Ingeniería Agroquímica en la Universidad Autónoma de Querétaro. Ha tenido la oportunidad de promocionar su carrera en diferentes semanas culturales que ofrece su facultad. En su generación solo son 2 mujeres, por lo que le es importante difundir las área de oportunidades para lograr que más mujeres se interesen por esta rama de la ciencia. Considera que en sus vidas pasadas fue bruja o hierbera porque tiene una fascinación hacia la botánica y las plantas medicinales. Practica yoga desde hace varios años. Puede ser una mujer de ciencia, pero le gusta leer su horóscopo y sabe leer el tarot. Le encanta ver cómo se mueven las hojas de los árboles con el aire y es amante de las flores.",
